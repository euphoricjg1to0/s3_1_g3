const virtualPet = {
    ...
    evolve: function() {
        if (this.happiness > 80 && this.hunger < 20) {
            this.type = "Irradiated Godzillasaurus";
            this.name = "Godzilla";
        } else if (this.happiness < 30 && this.hunger > 70) {
            this.type = "Irradiated Marine Iguana Kaiju";
            this.name = "Zilla";
        }
        this.updateImage();
    },
    ...
    updateImage: function() {
        let imageUrl = '';
        if (this.type === "Irradiated Godzillasaurus") {
            imageUrl = 'images/godzilla2019.png';  // Replace with the actual image URL
        } else if (this.type === "Irradiated Marine Iguana Kaiju") {
            imageUrl = 'images/zilla.png';  // Replace with the actual image URL
        } else {
            imageUrl = 'images/chibizilla.png';  // Replace with the default dragon image URL
        }
